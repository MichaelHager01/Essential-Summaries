...
# Creating folder for the google drive.
...
def index():
    ...
    if request.method == 'POST':
        ...
        with open(CLIENT_SECRET_FILE, 'r') as json_file:
        ...
        service = Create_Service(service_account_info, API_NAME, API_VERSION, SCOPES)

        # Get the ID of the "Website Uploads" folder
        website_uploads_folder_id = 'FOLDER_ID_SECRET'
